...
({
	...
	paths: 
	{
        ...
        'angular': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.24/angular.min',
        'angular-resource': 'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.0.7/angular-resource.min',
